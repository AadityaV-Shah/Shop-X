...
export default function Cosmetics() {
    ...
    useEffect(() => {
        fetch("https://dummyjson.com/products/category/beauty?limit=0")
            .then((res) => res.json())
            .then((data) => {
    ...
    if (loading) return <p className="text-center p-6">Loading cosmetic products...</p>;

    return (
        <section className="max-w-7xl mx-auto px-6 py-16 border-b-4">
            <h2 className="text-3xl font-bold mb-8 text-center text-black">Cosmetics</h2>
